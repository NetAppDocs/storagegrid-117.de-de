...
+
Wenn ein Benutzer zu mehreren Gruppen gehört, werden die Berechtigungen kumulativ. Siehelink:managing-admin-groups.html["Managen von Admin-Gruppen"] Entsprechende Details.
