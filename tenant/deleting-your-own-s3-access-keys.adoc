...
* Sie verfügen über die Berechtigung zum Verwalten Ihrer eigenen S3-Anmeldedaten. Siehe link:tenant-management-permissions.html["Mandantenmanagement-Berechtigungen"].
