...
[role="lead"]
Wenn Sie einen S3-Mandanten verwenden und über die entsprechenden Berechtigungen verfügen, können Sie eine Liste Ihrer S3-Zugriffsschlüssel anzeigen. Sie können die Liste nach Ablauf der Zeit sortieren, sodass Sie feststellen können, welche Schlüssel bald ablaufen. Nach Bedarf können Sie link:creating-your-own-s3-access-keys.html["Erstellen Sie neue Schlüssel"] Oder link:deleting-your-own-s3-access-keys.html["Schlüssel löschen"] Die Sie nicht mehr verwenden.
