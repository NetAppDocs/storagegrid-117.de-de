...
* Wenn Sie einer SG6060 Storage-Appliance ein oder zwei Erweiterungseinschübe hinzufügen möchten, fahren Sie mit fort link:../sg6000/adding-expansion-shelf-to-deployed-sg6060.html["Erweiterungs-Shelf für das implementierte SG6060 hinzufügen"].
* Befolgen Sie die Anweisungen für für, um einen softwarebasierten Node zu erhaltenlink:adding-storage-volumes-to-storage-nodes.html["Hinzufügen von Storage-Volumes zu Storage-Nodes"].
