...
[NOTE]
====
Alle vier Netzwerkports müssen dieselbe Verbindungsgeschwindigkeit verwenden. In der folgenden Tabelle finden Sie die für Ihre Hardware und Verbindungsgeschwindigkeit erforderlichen Geräte.
