...
. Wenn der Speicher-Node die Phase „`Warten auf manuelle Schritte`“ erreicht hat, fahren Sie mit fort link:remounting-and-reformatting-storage-volumes-manual-steps.html["Speicher-Volumes neu einbinden und formatieren (manuelle Schritte)"].
+
