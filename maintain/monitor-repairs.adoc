...
summary: 'Sie können den Status von Reparaturjobs mit der überwachen `repair-data` Skript über die Befehlszeile.' 
---
...
NOTE: Wenn Sie Volume-Wiederherstellungsjobs ausführen, link:../maintain/restoring-volume.html["Überwachen Sie den Fortschritt und zeigen Sie einen Verlauf dieser Jobs im Grid Manager an"] Stattdessen.
