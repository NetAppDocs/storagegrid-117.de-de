...
---
= Prüfen Sie, ob die Komponente im SGF6112 ausgetauscht werden soll
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Über diese Aufgabe
Gehen Sie wie folgt vor, um das Gerät mit fehlerhafter Hardware zu identifizieren und zu ermitteln, welche der folgenden austauschbaren Hardwarekomponenten nicht ordnungsgemäß funktioniert:
...
+
image::../media/nodes_page_hardware_tab_appliance_verify_nic.png[Appliance-Abschnitt für Hardwarekomponenten]
...
+
link:turning-sgf6112-identify-led-on-and-off.html["Schalten Sie die LED für die Geräteidentifschaltung ein und aus"]
