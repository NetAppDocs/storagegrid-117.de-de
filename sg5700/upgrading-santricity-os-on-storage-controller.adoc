...
Konsultieren Sie die https://["NetApp Interoperabilitäts-Matrix-Tool (IMT)"^] Um zu bestimmen, welche Version Sie verwenden sollen.

Laden Sie die neue Datei für die SANtricity OS Software von herunter https://["NetApp Downloads mit StorageGRID Appliance"^].
