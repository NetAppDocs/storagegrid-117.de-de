...
* Sie haben Zugriff auf https://["NetApp Downloads mit StorageGRID Appliance"^].
...
.Schritte
. [[Download-santricity-os]] Laden Sie die neue SANtricity OS Softwaredatei von herunter https://["NetApp Downloads mit StorageGRID Appliance"^].
+
