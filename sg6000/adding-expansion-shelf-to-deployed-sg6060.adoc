...
+
Das grüne Häkchen bedeutet, dass keine Meldungen aktiv sind und der Node mit dem Raster verbunden ist. Eine Beschreibung der Knotensymbole finden Sie unter link:../monitor/monitoring-system-health.html#monitor-node-connection-states["Überwachen Sie die Status der Node-Verbindung"].
