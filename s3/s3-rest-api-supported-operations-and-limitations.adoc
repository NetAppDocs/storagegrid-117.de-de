...
Das StorageGRID-System unterstützt die von definierten allgemeinen Anforderungsheader https://["Amazon Simple Storage Service API-Referenz: Common Request Header"^], Mit einer Ausnahme.
